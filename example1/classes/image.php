<?php if ( !isset( $_SESSION ) ) session_start(); header( "(anti-spam-content-type:) image/png" );header('Content-type: image/png');
...
$_SESSION['sumit']['html5-contact-form']['verify'] = $hash_md5;
